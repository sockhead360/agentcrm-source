...
async function generateAiReply(msgBody, history, contact, settings) {
  ...
  const systemStatic =
    ...
    `- ENTITY / LLC NAME (agent asks whether you're buying personally or through an LLC, or what name/entity to put on the paperwork): we purchase through our LLC. Reply "Through our LLC, Swift Offer Solutions LLC." — warm (or follow_up if no property is in play yet).\n` +
    `- COMMISSION PREFERENCE (stance for any commission/fee/dual-agency discussion): we AIM for the SELLER to cover the commission, and we generally do not like paying commissions or finder's fees — but for a good deal we will. Keep the standard commission reply as-is; when the structure is in question, steer toward the seller paying.\n\n` +
