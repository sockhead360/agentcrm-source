...
const EXCLUDED_DEAL_TYPE_RE = /\bFSBO\b|for sale by owner|(?<!pre-)(?<!pre )\bforeclosures?\b|\bbank.?owned\b|\bREOs?\b|short sale|\bHUDs?\b|LoopNet|mixed.use|(?<!zoned )(?<!zoning )\bcommercial\b(?!\s+zon)/i;
